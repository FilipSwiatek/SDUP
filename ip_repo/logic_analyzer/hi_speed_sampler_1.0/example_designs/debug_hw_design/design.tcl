...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins hi_speed_sampler_0/hi-speed_sampler]
	connect_bd_net [get_bd_pins hi_speed_sampler_0/hi-speed_sampler_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins hi_speed_sampler_0/hi-speed_sampler_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_hi_speed_sampler_0_hi-speed_sampler_* ]]
	puts $fp "set hi-speed_sampler_addr ${offset}"
