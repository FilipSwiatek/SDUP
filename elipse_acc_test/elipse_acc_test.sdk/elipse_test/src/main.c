...
#define A_ELIPSE_PARAMETER 3 // TODO check
...
int main(void){
	...
	ELIPSE_COPROCESSOR_mWriteReg(ELIPSE_BASE_ADDR, ELIPSE_A_REG_OFFSET, A_ELIPSE_PARAMETER);
	ELIPSE_COPROCESSOR_mWriteReg(ELIPSE_BASE_ADDR, ELIPSE_B_REG_OFFSET, B_ELIPSE_PARAMETER);
	// setting input angle
